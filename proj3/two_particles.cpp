...
int main(int argc, char* argv[])
{
  ...
  if (interaction == true){
  TXYZcord.save("TXYZcordsRK4true"+counter+".bin");    
  XYZ_Vel.save("XYZ_VelRK4true"+counter+".bin"); 
} else if (interaction == false){
  TXYZcord.save("TXYZcordsRK4false"+counter+".bin");    
  XYZ_Vel.save("XYZ_VelRK4false"+counter+".bin"); 
}
